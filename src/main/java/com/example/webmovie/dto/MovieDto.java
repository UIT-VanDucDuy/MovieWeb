...
public class MovieDto {
    ...
    public MovieDto(int id, String name, String mainActor, String author, String description, String releaseDate, boolean isSeries, int memberTypeId, String memberType, String posterPath, String bannerPath, String trailerPath, String moviePath, double duration) {
        this.id = id;
        this.name = name;
        this.mainActor = mainActor;
        this.author = author;
